...
adbtc_cookies = [
    {
        ...
        'value': 'f11ae84f80fbab7f179df193aa9e39a8b4097aca-1623078131-0-150',
        # <-- Replace by your CloudFlare session
        'domain': '.adbtc.top',
        'path': '/',
    },
    {
        ...
        'value': '4t7b5gk7fiujm0bthkndn438umuqf8f6',
        # <-- Replace by your session
        'domain': '.adbtc.top',
        'path': '/',
    },
...
if autoCaptcha:
    ...
    ac = captcha.Captcha(captchaServiceName, '1717b95ff4f4e4c2aee0e15af163aa86')
    # <-- Replace by your API Key
